...
skill_tab = [   # 技能总表
    # 0:爪击 1:毒爪 2:洞察提升 3:取敌首
    Claw_hit(), Claw_poison(), Insight_up(), Deadly_blow(),
    # 4:哼 5:哼哼 6:招蜂引蝶 7:群体嘲讽
    Despise(), Despise_rand(), Flirt(), Deadly_everyone(),
    # 8:混乱打击 9:精准打击 10:秘籍：否认三连 11:精准的混乱打击
    Chaos_hit(), Accurate_hit(), Deny(), Double_Accurate_hit(),
    # 12:一刀 13:用力一刀 14:身经百战 15:全力一刀
    One_knife(), Force_knife(), Veteran(), All_knife(),
    # 16:奶一口 17:你也要喝吗 18:体育生 19:奶起来
    MyselfHp_up(), TeamHp_up(), Sports_man(), AllHp_up(),
    # 20:怜悯 21:仙人一指 22:主角光环 23:八卦像
    Defy(), One_finger(), Lead_halo(), Tai_chi(),
    Ordinary_knife(), Ordinary_force_knife(), Dormitory_head(
    ), Drunk_knife(),  # 24:普通一刀 25:普通用力一刀 26:一舍之长 27:趁醉一击
    # 28:电击 29:连锁电击 30:知识就是力量 31:暗物质攻击
    Electric(), Electric_chain(), Knowledge(), Dark_matter(),
]
